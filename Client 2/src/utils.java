...
public class utils {
    ...
    public static String RunScript(String filename, History history,ConnectModule connection) {
        try {
            ...
            while (input.hasNextLine()) {
                print_prompts = false;
                String result = Dispatcher.parseCommand(input,history,connection );
                if (result==null) return "exit";
        ...
        return "Скрипт " + filename +" обработан успешно";
    }
