...
public class Commands {
     ...
     */
    public static List<RouteRow> show() {
        utils.lock.readLock().lock();
        List<RouteRow> routeList = new ArrayList<RouteRow>();
        //String s = "";
        utils.collection.getSet();
        Iterator<Route> elements = utils.collection.getSet().iterator();
        while (elements.hasNext()) {
            Route r = elements.next();
            routeList.add(new RouteRow(
                    r.getId(),
                    r.getName(),
                    r.getDistance(),
                    r.getCreationDate(),
     ...
     * @return строка с информацией об элементах коллекции
     */
    public static List<RouteRow> filter_contains_name(String name) {
        utils.lock.readLock().lock();
        List<RouteRow> routeList = new ArrayList<RouteRow>();
        utils.collection.getSet();
        Iterator<Route> elements = utils.collection.getSet().iterator();
