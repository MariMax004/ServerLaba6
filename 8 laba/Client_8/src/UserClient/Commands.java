...
/**
 *Класс UserClient.Commands хранит в себе информацию и назначения всех команд
 */
public class Commands {

    /**
     * Метод выводит в стандартный поток вывода информацию о коллекции (тип, дата инициализации, количество элементов и т.д.)
     * @param collection  обьект класса UserClient.RouteCollection
     ...
     * @return  строка с информацией об элементах коллекции
     */
   /*/ public static Server.Container update( String id, Scanner input) {

            Route new_route = inputRoute(Integer.parseInt(id), input);

            return new Server.Container("update", new_route);
