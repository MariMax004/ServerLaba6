...
public class AddIfController {
    ...
    void initialize() {
        ...
        add_route.setOnAction(event -> {
            ...
            if (newRoute != null) {
                String result = utils.connection.runCommand(new Server.Container("add_if_max", newRoute));
                if (result.equalsIgnoreCase("Элемент добавлен")) {
                    ...
                    add_route.getScene().getWindow().hide();
                } else {
